        ...
        <div className='container-fluid'>
            ...
            <div className='container'>
                        ...
                        <div className="review-content">
                            ...
                            <div className="review-info">
                                ...
                                <div className="review-container">
                                    <h2 className="review-title">Đánh giá từ phụ huynh</h2>
                                    <div className="review-rating"> 4.94/5</div>
                                    ...
                                    <p className="review-description">Xem chi tiết 635 đánh giá</p>
                                    <div className="review-category-rating">
                                        <div className="review-category">Tư thục</div>
                                        <div className="review-container-number">319
                                            Khuyên học</div>
                                        <div className="review-container-rating">616
                                            Đăng ký học</div>
                                    </div>
                                    {/* <div className="review-category-rating">
                ...
                <div className="column3">
                    ...
                    <section className="about_School_teacher">
