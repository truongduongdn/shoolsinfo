...
function JuniorHighSchool(props) {
    return (
        <>
        <div className={style.introabouttype}>
        <p className={style.titleIntroType}> Top 25 newest Junior schools May 2024</p>
        <p className={style.SubtitleIntroType}> List of detailed reviews of +100 private, bilingual, public, and international high schools with tuition from only 2 million VND</p>
         <BoxSearch />
         </div>
