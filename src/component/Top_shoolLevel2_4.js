...
import anh5_4_item from '../assets/images/anh5-4.webp'
function Top_shoolLevel2_4(props) {
    return (
        <div className='top_level2-3'>
            {/* 1 */}
            <div className='top_level23-about'>
                <img className='top_level1-img' src={anh5_4_item}></img>
            </div>
            {/* 2 */}
            <div>
                <p className='top_level1_text_main'>
                    Thanh Thu Secondary School (TT) </p>
                <div className='top_level1-assess'>
                    <div className='top_level1-assess-point'>9.3</div>
                    <div className='top_level1-assess-assess' >
                        <p className='top_level1-assess-1'  >Good</p>
                        <p className='top_level1-assess-2'>Top 2</p>
                    </div>
                </div>
...
export default Top_shoolLevel2_4;