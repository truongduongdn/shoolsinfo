...
function ReviewSchool(props) {
    ...
    function handleWriteReview(){
        if (isLoggedIn) {
            // User is logged in, allow them to write a review
            // Add your logic here to enable writing a review
        } else {
    ...
    return (
        <div>
            <form onSubmit={handleSubmit}>
                ...
                <button type="submit" className="btn btn-success" onClick={handleWriteReview}>Send your review</button>
            </form>
        </div>
    );
}
